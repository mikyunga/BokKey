...
const signUpPage = () => {
  return (
    <div className="flex flex-col">
      <div className="relative h-screen overflow-y-auto gap-[80px] flex flex-col">
        ...
        <div className="flex justify-center items-center ">
          <div
            className="w-[404px] p-[42px] gap-[32px] overflow-hidden
          ...
          >
            ...
            <div>
              ...
              <div className="text-[28px] font-bold ">회원가입</div>
            </div>
            <SignUpForm />
          </div>
        </div>
