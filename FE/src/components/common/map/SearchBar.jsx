    ...
    <div className="relative">
      <input
        ...
        className="w-full px-4 py-[10px] pr-9 
                   bg-[rgba(0,0,0,0.02)] 
                   border border-[rgba(0,0,0,0.015)] rounded-full 
                   text-[16px] placeholder:text-[rgba(0,0,0,0.6)] 
      ...
      <Search
        strokeWidth={1.75}
        className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[rgba(0,0,0,0.7)]"
      />
    </div>
  );
}
